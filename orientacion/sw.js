/* MILITOPO · cache offline seguro v116 · tabla puntos columnas juntas según raya*/
const MILITOPO_CACHE = "militopo-orientacion-modular-v116-tabla-columnas-juntas-raya";
const CORE_ASSETS = [
  "./",
  "./index.html",
  "./js/app.js",
