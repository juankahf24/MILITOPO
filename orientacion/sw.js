/* MILITOPO · cache offline seguro v109 · paso2 bloque buscar zona más moderno */
const MILITOPO_CACHE = "militopo-orientacion-modular-v109-step2-atak-principal-appmain";
const CORE_ASSETS = [
  "./",
  "./index.html",
  "./js/app.js",
