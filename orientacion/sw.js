/* MILITOPO · cache offline seguro v119 · tabla como antes columnas más cerca */
const MILITOPO_CACHE = "militopo-orientacion-modular-v119-tabla-como-antes-mas-cerca";
const CORE_ASSETS = [
  "./",
  "./index.html",
  "./js/app.js",
