/* MILITOPO · cache offline seguro v96 · IOF rosa canvas + logo escudo nuevo */
const MILITOPO_CACHE = "militopo-orientacion-modular-v96-iof-rosa-canvas-auto-logo-escudo";
const CORE_ASSETS = [
  "./",
  "./index.html",
  "./js/app.js",
