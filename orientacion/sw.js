/* MILITOPO · cache offline seguro v88 · IOF rosa fase 1C inline fixed */
const MILITOPO_CACHE = "militopo-orientacion-modular-v89-iof-rosa-header-fixc-fixed-inline";
const CORE_ASSETS = [
  "./",
  "./index.html",
  "./js/app.js",
