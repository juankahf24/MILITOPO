...
function buildOrganizerPanel() {
  ...
  panel.innerHTML = `
    ...
    <div class="militopo-live2-table-wrap">
      <table class="militopo-live2-table"><colgroup><col style="width:22%"><col style="width:13%"><col style="width:11%"><col style="width:14%"><col style="width:15%"><col style="width:9%"><col style="width:8%"><col style="width:8%"></colgroup><thead><tr><th>Participante</th><th>Estado</th><th class="militopo-live2-th-nowrap">Progreso</th><th class="militopo-live2-th-two-lines"><span>Puntos</span><span>descartados</span></th><th>Última sincronización</th><th>Salida</th><th>Llegada</th><th>Tiempo total</th></tr></thead><tbody id="live2ParticipantsBody"><tr><td colspan="8" class="militopo-live2-empty">Inicia la carrera en vivo para preparar los participantes.</td></tr></tbody></table>
    </div>`;
